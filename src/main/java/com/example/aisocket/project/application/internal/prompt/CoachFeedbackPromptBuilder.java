...
import com.example.aisocket.project.application.internal.prompt.template.PromptTemplate;
import com.example.aisocket.project.application.internal.prompt.template.section.SingleWorkoutCommonSection;
import com.example.aisocket.project.application.internal.prompt.template.section.SingleWorkoutHallucinationGuardSection;
import com.example.aisocket.project.application.internal.prompt.template.section.SingleWorkoutOutputFormatSection;
import com.example.aisocket.project.application.internal.prompt.template.SingleWorkoutPromptContext;
import com.example.aisocket.project.application.internal.prompt.template.SingleWorkoutPromptTemplate;
import com.example.aisocket.project.application.internal.prompt.template.section.SingleWorkoutSpecificSection;
import com.example.aisocket.project.application.internal.prompt.template.section.SingleWorkoutSystemInstructionSection;
